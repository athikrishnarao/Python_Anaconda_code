import sqlite3
from PythonTestLeaf.LearnDataBase.TestData import Test_Data
...
class Data_Base:
    ...
    def update_records(self,con):
        qrr = f'''UPDATE {self.table_name} set pwd = '1234587980' WHERE fName='Sarath' '''
        con.execute(qrr)
        con.commit()
        print("Updated")
